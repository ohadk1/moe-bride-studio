...
const Services = () => {
  ...
  // Number of services to display per page on mobile
  ...
  // Calculate total pages for mobile carousel
  const totalPages = Math.ceil(displayedServices.length / servicesPerPage);
  
  // Sliced services for mobile view
          ...
          <div className="flex flex-col space-y-6">
            {mobileServices.map((service, index) => (
              <div 
                ...
                style={{ animationDelay: `${0.1 * index}s`, animationFillMode: 'forwards' }}
              >
                <div className="bg-white rounded-3xl shadow-xl p-6 flex flex-col h-full group border border-gray-100">
                  <div className="mb-4">
