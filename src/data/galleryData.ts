...
export const galleryItems = [
  // Wedding dress items (keeping these)
  {
    id: 9,
    title: "",
  ...
  // New evening dress items from uploaded photos
  {
    id: 100,
    title: "",
